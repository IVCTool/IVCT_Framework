...
//			this.testRunner.executeTests(logger, info.sutName, testcases, info.testCaseParam.toString(), verdicts);
       ...
       /** 
        * Check the  compability of IVCT-Version which had this testCase at building-time
        * against the IVCT-Version at Runtime 
        */
        logger.debug("TestEngine: start check 'IVCT-Version of testcase build' - against 'IVCT-Version of Tc.exec' ");
