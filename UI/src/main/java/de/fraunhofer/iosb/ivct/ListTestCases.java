...
/*
 * This class gets and displays the test schedules / test cases for a test suite.
 */
...
public class ListTestCases implements Command {
	final IVCTcommander ivctCommander;
	RuntimeParameters rtp;
	String testsuite;
	boolean displayList;

	ListTestCases(IVCTcommander ivctCommander, RuntimeParameters rtp, final String testsuite, final boolean displayList) {
